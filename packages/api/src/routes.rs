...
#[get("/graphql?<query..>")]
pub async fn graphql_query(schema: &State<PiteoSchema>, query: Query) -> Response {
    query.execute(schema).await
}

#[post("/graphql", data = "<request>", format = "application/json")]
pub async fn graphql_request(schema: &State<PiteoSchema>, request: Request) -> Response {
